...
def draw_start_screen():
    ...
    draw_text(20, 40, "F1: Start/Continue", GLUT_BITMAP_HELVETICA_12)
    draw_text(20, 20, "F2: Pause", GLUT_BITMAP_HELVETICA_12)
...
def draw_pause_screen():
    ...
    draw_text_center(WINDOW_WIDTH/2, WINDOW_HEIGHT/2-100, "F1 to CONTINUE", GLUT_BITMAP_HELVETICA_18)
...
def draw_level_complete_screen():
    ...
    draw_text_center(WINDOW_WIDTH/2, WINDOW_HEIGHT/2-70, "F1 to continue", GLUT_BITMAP_HELVETICA_12)
...
def draw_game_over_screen():
    ...
    draw_text_center(WINDOW_WIDTH/2, WINDOW_HEIGHT/2-70, "F1 to restart", GLUT_BITMAP_HELVETICA_12)
...
def draw_hud():
    ...
    # Control reminders
    draw_text(WINDOW_WIDTH-200, WINDOW_HEIGHT-30, "F1: Continue", GLUT_BITMAP_HELVETICA_12)
    draw_text(WINDOW_WIDTH-200, WINDOW_HEIGHT-50, "F2: Pause", GLUT_BITMAP_HELVETICA_12)
...
def keyboardListener(key, x, y):
    ...
    # F1 key for start/continue/restart
    if key == b'\x01':  # F1 key
